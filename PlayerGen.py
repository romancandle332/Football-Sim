...
class Player():
    def __init__(self,firstname,lastname,suffix,position,potential):
        ...
        self.Speed = 1.0 ##Straight line speed
        self.Agility = 1.0 ##Ability to change direction
        self.Jumping = 1.0 ##Ability to high-point catches
        self.ThrowStrength = 1.0 ##Low underthrows deep passes and is more likely to be picked off, High causes more drops
        self.ThrowAccuracy = 1.0 ##Ability to throw a catchable ball
        self.ThrowTouch = 1.0 ##Ability to place the ball. Low lowers completion rate, yards after catch. High lowers drops and raises yards after catch.
        self.ThrowVision = 1.0 ##Ability to determine if a player is open
        self.PocketAwareness = 1.0 ##Ability to feel the pass rush
        self.PlayAction = 1.0 ##Ability to fool the defense
        self.Carrying = 1.0 ##Ability to avoid fumbling
        self.BreakTackle = 1.0 ##Ability to break a tackle (any way)
        self.RunVision = 1.0 ##Also used as option ability for QBs
        self.Catching = 1.0 ##Ability to catch a pass
        self.ContestCatching = 1.0 ##Ability to catch a pass in traffic or before being hit
        self.RouteRunning = 1.0 ##How well they run a route to create separation
        self.Release = 1.0 ##How well they start their route and beat press coverage
        self.PassBlocking = 1.0 ##Ability to prevent a defender from going past them
        self.RunBlocking = 1.0 ##Ability to push a defender backwards
        self.Snapping = 1.0 ##Ablity to snap on normal plays
        self.Longsnapping = 1.0 ##Ability to snap on special teams plays
        self.Tackling = 1.0 ##Ability to break the ballcarrier down
        self.HitPower = 1.0 ##Ability to cause fumbles and drops by hitting hard
        self.SpeedRush = 1.0 ##Ability to get around a blocker
        self.PowerRush = 1.0 ##Ability to push a blocker backwards or over
        self.BlockShedding = 1.0 ##Ability to get off a block (to chase a carrier who ran past you)
        self.PressCoverage = 1.0 ##Ability to jam the receiver at the line
        self.ManCoverage = 1.0 ##Ability to follow a receiver across the field
        self.ZoneCoverage = 1.0 ##Ability to patrol a patch of field and cover who comes into it
        self.PuntPower = 1.0 ##Power behind a drop kick
        self.PuntAccuracy = 1.0 ##Ability to aim a drop kick
        self.KickPower = 1.0 ##Power behind a place kick
        self.KickAccuracy = 1.0 ##Ability to aim a place kick
        self.Injury = 1.0 ##How likely they are to be injured/How many "BIG HIT"s can they take before they retire at the end of the season? Pro Only
